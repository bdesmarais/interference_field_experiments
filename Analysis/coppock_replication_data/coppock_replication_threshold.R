...
for(i in 1:nrow(parameters)){
  ...
  if(i/100==round(i/100)) save(list=c("pval","parameters"),file="CoppockSPPQRRresults_threshold60_scaled.RData")
}
...
# Limit to 30% most similar
threshold <- quantile(c(S.ideo),0.60)
S.ideo <- 1*(S.ideo>=threshold)
...
for(i in 1:nrow(parameters)){
  ...
  if(i/100==round(i/100)) save(list=c("pval","parameters"),file="CoppockSPPQRRresults_threshold60_unscaled.RData")
}
...
for(i in 1:nrow(parameters)){
  ...
  if(i/100==round(i/100)) save(list=c("pval","parameters"),file="CoppockSPPQRRresults_threshold80_scaled.RData")
}
...
for(i in 1:nrow(parameters)){
  ...
  if(i/100==round(i/100)) save(list=c("pval","parameters"),file="CoppockSPPQRRresults_threshold80_unscaled.RData")
}
