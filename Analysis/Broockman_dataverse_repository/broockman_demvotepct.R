...
setwd("~/Dropbox/professional/Research/Active/causalityinnetworks-agenda/Interference_in_Field_Experiments/Analysis/Broockman_dataverse repository") #BD
...
# write.csv(adj.mat, "demvotepct_network.csv", row.names = FALSE, na = '')
